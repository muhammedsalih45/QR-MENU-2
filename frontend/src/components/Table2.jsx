...
const Table = () => {
  ...
  const filterProducts = selectedCategory
    ? rows.filter(product => product.category_id === selectedCategory.value)
    : rows;
        ...
        <table className="table">
          ...
          <tbody>
            {record.map(row => (
              <tr
                key={row.product_id}
                className={row.is_available ? 'faded disabled' : ''}
              >
                <td>
                  <input
                    className="form-check-input"
                ...
                <td>{row.price}</td>
                <td>
                  {row.Category ? row.Category.category_name : 'Kategori Yok'}
                </td>
                <td className="edit">
                  <i
